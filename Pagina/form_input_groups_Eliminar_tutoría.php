		...
		<div class="content-wrapper">
			...
			<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Eliminar tutorías</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se eliminan los datos de las tutorías.</p>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round">Eliminar tutoría</button>
	                    	</div>
						</div>
					</div>
								<!--
