		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Alumnos</span> - Basic</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p>Lista de la información de los alumnos</p>
						...
						<div class="btn-group">
					    	 <button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate dropdown-toggle" data-toggle="dropdown">Ajustes</button>
					   	 	<div class="dropdown-menu dropdown-menu-right">
							<a href="form_input_groups_Eliminar.php" class="dropdown-item"><i class="icon-menu7"></i>Modificar</a>
							<a href="form_input_groups_Eliminar_alumno.php" class="dropdown-item"><i class="icon-screen-full"></i>Eliminar</a>
							</div>
						</div>
					</div>
				</div>
