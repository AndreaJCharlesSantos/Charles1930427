			...
			<div class="sidebar-content">
				...
				<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Tutoría</div> <i class="icon-menu" title="Forms"></i></li>
					<li class="nav-item nav-item-submenu">
						...
						<ul class="nav nav-group-sub" data-submenu-title="Form components">
							<li class="nav-item">
								<a href="datatable_basic_Tutorias.php" class="nav-link">
								<i class="icon-home4"></i>
		...
		<div class="content-wrapper">
			...
			<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Modificar tutorías</h5>
					...
					<div class="card-body">
						<p class="mb-4">En este formulario se actualizan los datos de las tutorías.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Fecha de la sesión</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
											</span>
											<input type="text" class="form-control" placeholder="Ingresar la fecha de la sesión">
										</div>
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Tema atendido por el tutor</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Ingresar el tema impartido">
											</span>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre del empleado (tutor)</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Ingresar el nombre del empleado">
											</span>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese el número del empleado">
										</div>
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Departamento asignado</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
											</span>
											<input type="text" class="form-control" placeholder="Ingrese el departamento del empleado">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingresar la matrícula del alumno">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="Ingrese la carrera que está cursando">
										</div>
									</div>
								</div>
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
		                    	...
		                    	<button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate-600 rounded-round">Modificar tutoría</button>
	                    	</div>
						</div>
					</div>
								<!--
