	...
	<div class="page-content">
					...
					<div class="card-body">
						...
						<div class="btn-group">
					    	 <button type="button" class="btn btn-outline bg-slate-600 text-slate-600 border-slate dropdown-toggle" data-toggle="dropdown">Ajustes</button>
					   	 	<div class="dropdown-menu dropdown-menu-right">
							<a href="form_input_groups_Empresas_Modificar_tutoría.php" class="dropdown-item"><i class="icon-menu7"></i>Modificar</a>
							<a href="form_input_groups_Eliminar_tutoría.php" class="dropdown-item"><i class="icon-screen-full"></i>Eliminar</a>
							</div>
						</div>
					</div>
				</div>
	   ...
	   <!-- Edit modal -->
								...
								<div class="table-responsive aa">
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												<td><input type="numbers" class="form-control" value="ID"></td>
												<td><input type="text" class="form-control" value="Fecha"></td>
												<td><input type="text" class="form-control" value="Tema" ></td>
												<td><input type="text" class="form-control" value="Nombre del empleado"></td>
												<td><input type="text" class="form-control" value="Número del empleado"></td>
												<td><input type="numbers" class="form-control" value="Departamento"></td>
												<td><input type="text" class="form-control" value="Matrícula"></td>
												<td><input type="numbers" class="form-control" value="Nombre"></td>
												<td><input type="text" class="form-control" value="Carrera"></td>
		 ...
		 <!-- Remove modal -->
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h1 class="modal-title">Ingrese sesión</h1>
										<button type="button" class="close" data-dismiss="modal">&times;</button>
									</div>

									<div class="modal-body">
										<h2>Usuario</h2>
										<td><input type="text" class="form-control" value="Usuario"></td>
										<h2>Contraseña</h2>
										<td><input type="text" class="form-control" value="Contraseña"></td>
									</div>

									<div class="modal-footer">
									<a href="#" class="btn btn-primary"data-toggle="modal" data-target="#remove_modal2"><span>Ingresar</span></a>
				...
				<!-- Remove modal -->
						<div id="remove_modal2" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
